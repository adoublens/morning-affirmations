      ...
      <section className="section bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            {/* Loading Dots */}
            <div className="card">
              <h3 className="text-xl font-semibold mb-4">Loading Dots</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <LoadingDots size="sm" text="Small" />
                </div>
                <div className="text-center">
                  <LoadingDots size="md" text="Medium" />
                </div>
                <div className="text-center">
                  <LoadingDots size="lg" text="Large" />
                </div>
              </div>
            </div>
            ...
            {/* Loading Pulse */}
            <div className="card">
              <h3 className="text-xl font-semibold mb-4">Loading Pulse</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <LoadingPulse size="sm" text="Small" />
                </div>
                <div className="text-center">
                  <LoadingPulse size="md" text="Medium" />
                </div>
                <div className="text-center">
                  <LoadingPulse size="lg" text="Large" />
                </div>
              </div>
            </div>
