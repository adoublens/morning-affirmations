...
export function WatchButton({ url, title }: WatchButtonProps) {
  ...
  return (
    ...
    >
      <svg 
        className="!w-5 !h-5 !mr-2 group-hover:scale-110 transition-transform duration-200 text-[var(--theme-primary)]" 
      ...
      <span className="text-[var(--theme-primary)]">Watch Video</span>
